...
const Testimonials = () => {
  return (
    ...
    className='w-full container mx-auto py-10 lg:px-32 overflow-hidden' id='Testimonials'>
    ...
    <div className='flex justify-center gap-8 flex-wrap'>
        {testimonialsData.map((testimonial,index ) => (
            <div key={index} className='max-w-[320px] border-0 shadow-xl rounded px-8 py-12 text-center bg-white' >
